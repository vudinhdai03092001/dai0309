...
const getData = async () => {
  let res = await axios.get(
    `https://localhost:44396/Hoadonnhap/${currentPage.value}`
  );
...
const handleAddProduct = async () => {
  ...
  let res = await axios.post("https://localhost:44396/Hoadonnhap", payload);
...
const deleteProduct = async (id) => {
  ...
  let res = await axios.delete(`https://localhost:44396/Hoadonnhap/${id}`);
...
const handleEditProject = async () => {
  ...
  let res = await axios.put(
    `https://localhost:44396/Hoadonnhap/${selectedItem.value.id}`,
    payload
  );
 ...
 <Toast />
    ...
    >
      ...
      <div
        ...
        style="margin-top: 10px; padding-left: 150px; width: 500px"
      >
        <label for="nameProduct">Ngày nhập</label>
       <InputText
          style="border: 1px solid black"
          class="divide-black"
          id="image"
      ...
      <div
        ...
        style="margin-top: 10px; padding-left: 150px; width: 500px"
      >
        <label for="describle">Tổng tiền</label>
        <InputText
          style="border: 1px solid black"
          class="divide-black"
          id="describle"
    ...
    <label for="nameProduct" style="font-size: 20px">Tên sản phẩm </label>
      <div class="field col-12 md:col-8">
        <span class="p-float-label">
          <InputText
            id="nameProduct"
      ...
      <label for="image" style="font-size: 20px">Ngày nhập</label>
      <div class="field col-12 md:col-8">
      ...
      <label for="amount" style="font-size: 20px">Số lượng</label>
      <div class="field col-12 md:col-8">
        <div class="p-float-label">
          <!-- <label for="image">Image </label> -->
          <InputText
      ...
      <label for="price" style="font-size: 20px">Tổng tiền </label>
      <div class="field col-12 md:col-8">
        <div class="p-float-label">
          <!-- <label for="image">Image </label> -->
          <InputText
